...
public class TestRollingConfigChange
{
    ...
    public void testFailedQuorum() throws Exception
    {
        ...
        {
            private volatile ConfigCollection config = new PropertyBasedInstanceConfig(new Properties(),
                    new Properties());
        ...
        InstanceState state = new InstanceState(serverList, InstanceStateTypes.NOT_SERVING,
                new RestartSignificantConfig(null));
        ...
        try
        {
            ...
            properties.setProperty(PropertyBasedInstanceConfig.toName(StringConfigs.SERVERS_SPEC,
                    PropertyBasedInstanceConfig.ROOT_PROPERTY_PREFIX), serverList.toSpecString());
            PropertyBasedInstanceConfig config = new PropertyBasedInstanceConfig(properties,
                    DefaultProperties.get(null));
    ...
    public void testLongQuorumSuccess() throws Exception
    {
        ...
        properties.setProperty(PropertyBasedInstanceConfig.toName(StringConfigs.SERVERS_SPEC,
                PropertyBasedInstanceConfig.ROOT_PROPERTY_PREFIX), serverList.toSpecString());
        properties.setProperty(PropertyBasedInstanceConfig.toName(StringConfigs.SERVERS_SPEC,
                PropertyBasedInstanceConfig.ROLLING_PROPERTY_PREFIX), serverList.toSpecString());
        ...
        try
        {
            ...
            InstanceState instanceState = new InstanceState(serverList, InstanceStateTypes.NOT_SERVING,
                    new RestartSignificantConfig(null));
    ...
    public void testDownMiddleInstance() throws Exception
    {
        ...
        InstanceState state = new InstanceState(serverList, InstanceStateTypes.SERVING, new RestartSignificantConfig(
                null));
        ...
        try
        {
            ...
            for (String hostname : manager.getRollingConfigState().getRollingHostNames())
            {
                ...
                {
                    for (int i = 1; i < ConfigManager.DEFAULT_MAX_ATTEMPTS; ++i) // don't check last time as it's
                                                                                 // cleared on MAX
                    {
