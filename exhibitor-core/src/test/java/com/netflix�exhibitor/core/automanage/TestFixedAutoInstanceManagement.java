...
public class TestFixedAutoInstanceManagement
{
    ...
    public void testSimpleAddition() throws Exception
    {
        ...
        mockExhibitorInstance.getMockConfigProvider()
                .setConfig(IntConfigs.AUTO_MANAGE_INSTANCES_FIXED_ENSEMBLE_SIZE, 3);
        ...
        Mockito.when(mockExhibitorInstance.getMockForkJoinPool().invoke(Mockito.isA(ClusterStatusTask.class)))
                .thenReturn(statuses);

        final AtomicBoolean configWasChanged = new AtomicBoolean(false);
        AutomaticInstanceManagement management = new AutomaticInstanceManagement(
                mockExhibitorInstance.getMockExhibitor())
        {
            @Override
        ...
        Assert.assertEquals(
                mockExhibitorInstance.getMockExhibitor().getConfigManager().getConfig()
                        .getString(StringConfigs.SERVERS_SPEC), "1:a,2:b,3:new");
    }
    ...
    public void testReplacement() throws Exception
    {
        ...
        Assert.assertEquals(
                mockExhibitorInstance.getMockExhibitor().getConfigManager().getConfig()
                        .getString(StringConfigs.SERVERS_SPEC), "1:a,3:c,4:new");
    }
    ...
    public void testNoRoom() throws Exception
    {
        ...
        Assert.assertEquals(
                mockExhibitorInstance.getMockExhibitor().getConfigManager().getConfig()
                        .getString(StringConfigs.SERVERS_SPEC), "1:a,2:b,3:c");
    }
    ...
    public void testBecomesObserver() throws Exception
    {
        ...
        mockExhibitorInstance.getMockConfigProvider().setConfig(IntConfigs.AUTO_MANAGE_INSTANCES_SETTLING_PERIOD_MS, 0);
        mockExhibitorInstance.getMockConfigProvider()
                .setConfig(IntConfigs.AUTO_MANAGE_INSTANCES_FIXED_ENSEMBLE_SIZE, 4);
        ...
        Assert.assertEquals(
                mockExhibitorInstance.getMockExhibitor().getConfigManager().getConfig()
                        .getString(StringConfigs.SERVERS_SPEC), "1:a,2:b,3:c,O:4:new");
    }
}
